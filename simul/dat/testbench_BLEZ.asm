...
# add, sub, and, or, slt, addi, lw, sw, beq, j, BLEZ
...
blez $4, end			# shouldn’t be taken	1c 1880000a		***********
slt $4, $3, $4			# $4 = 12 < 7 = 0		20 0064202a
blez $4, around			# should be taken		24 18800001		***********
...
# Blez	I	6	-	Branch less than or equal zero	N
