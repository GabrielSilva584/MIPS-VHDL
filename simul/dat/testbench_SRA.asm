...
# add, sub, and, or, slt, addi, lw, sw, beq, j, SRA
# If successful, it should write the value 7 to address 84
# Assembly Description Address Machine
main: addi $2, $0, 5	# initialize $2 = 5		0 20020005
addi $3, $0, 12			# initialize $3 = 12	4 2003000c
addi $7, $3, -9			# initialize $7 = 3		8 2067fff7
addi $6, $0, -16		# initialize $6 = -16	c 2006fff0		***********
or $4, $7, $2			# $4 <= 3 or 5 = 7		10 00e22025
sra $5, $6, 4			# $5 <= -16 >> 4 = -1	14 00062903		***********
add $5, $5, $3			# $5 = -1 + 12 = 11		18 00a32820
...
# Sra	R	0	3	Shift Right Arithmetical	N
