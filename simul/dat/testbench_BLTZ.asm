...
# add, sub, and, or, slt, addi, lw, sw, beq, j, BLTZ
...
bltz $4, end			# shouldn’t be taken	1c 0480000a		***********
addi $4, $0, -1			# initialize $4 = -1	20 2004ffff
bltz $4, around			# should be taken		24 04800001		***********
...
# Bltz	I	1	0	Branch less than zero	
