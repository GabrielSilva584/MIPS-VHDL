...
# add, sub, and, or, slt, addi, lw, sw, beq, j, BGTZ
...
bgtz $0, end			# shouldn’t be taken	1c 1c00000a		***********
slt $4, $3, $4			# $4 = 12 < 7 = 0		20 0064202a
bgtz $3 around			# should be taken		24 1c600001		***********
...
# Bgtz	I	7	-	Branch greater than zero 	N
